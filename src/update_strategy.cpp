...
void ExplicitUpdate::update(Field& field, double dt, double dx, double D) {
...
void ImplicitUpdate::update(Field& field, double dt, double dx, double D) {
    size_t n = field.size();
...
void ImplicitUpdate::solve_tridiagonal(
